...
exports.migrations = [
    ...
    },
    {
      ...
      CREATE UNIQUE INDEX IF NOT EXISTS idx_source_artifacts_content_hash ON source_artifacts(content_hash);
      ...
      CREATE INDEX IF NOT EXISTS idx_extraction_snapshots_artifact ON extraction_snapshots(source_artifact_id, created_at DESC);
      ...
      CREATE INDEX IF NOT EXISTS idx_candidate_evidence_subject ON candidate_evidence(subject_type);
      CREATE INDEX IF NOT EXISTS idx_candidate_evidence_verification ON candidate_evidence(verification_state);
      ...
      CREATE INDEX IF NOT EXISTS idx_evidence_source_links_evidence ON evidence_source_links(evidence_id);
      CREATE INDEX IF NOT EXISTS idx_evidence_source_links_artifact ON evidence_source_links(source_artifact_id);
      ...
      CREATE INDEX IF NOT EXISTS idx_requirement_evidence_maps_requirement ON requirement_evidence_maps(job_requirement_id);
      ...
      CREATE INDEX IF NOT EXISTS idx_resume_projections_job ON resume_projections(job_id);
      ...
      CREATE INDEX IF NOT EXISTS idx_resume_statements_projection ON resume_statements(projection_id, display_order);
      ...
      CREATE INDEX IF NOT EXISTS idx_resume_artifacts_projection ON resume_artifacts(projection_id, version DESC);
      ...
      CREATE INDEX IF NOT EXISTS idx_application_artifact_links_application ON application_artifact_links(application_id);
    `,
    },
];
